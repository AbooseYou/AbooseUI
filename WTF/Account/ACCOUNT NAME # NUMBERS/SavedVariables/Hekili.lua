...
HekiliDB = {
	...
	["profileKeys"] = {
		...
		["Myironballs - Stormrage"] = "AbooseUI",
		["Iabooseyou - Stormrage"] = "AbooseUI",
		["Aboose - Stormrage"] = "AbooseUI",
		["Lilobv - Illidan"] = "AbooseUI",
		["Abooseyou - Stormrage"] = "AbooseUI",
		["Pallyneess - Illidan"] = "AbooseUI",
		["Paintchíps - Stormrage"] = "AbooseUI",
		["Usb - Stormrage"] = "AbooseUI",
		["Pallyness - Stormrage"] = "AbooseUI",
		["Tríggered - Stormrage"] = "AbooseUI",
		["Affixes - Stormrage"] = "AbooseUI",
		["Rogueness - Stormrage"] = "AbooseUI",
		["Rogueness - Illidan"] = "AbooseUI",
		["Affixe - Stormrage"] = "AbooseUI",
		["Õbv - Area 52"] = "Default",
					...
					["lists"] = {
						["aoe"] = {
							...
							}, -- [2]
							{
								["enabled"] = true,
								["action"] = "flame_shock",
								["criteria"] = "talent.fire_nova.enabled || covenant.necrolord",
								["cycle_targets"] = 1,
							}, -- [3]
							{
								["enabled"] = true,
								["action"] = "primordial_wave",
								["criteria"] = "! buff.primordial_wave.up & ( ! talent.stormkeeper.enabled || buff.stormkeeper.up )",
								["cycle_targets"] = 1,
							}, -- [4]
							{
								["action"] = "vesper_totem",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.stormkeeper.up & buff.maelstrom_weapon.stack >= 5",
							...
							}, -- [12]
							{
								["enabled"] = true,
								["action"] = "flame_shock",
								["criteria"] = "talent.fire_nova.enabled",
								["cycle_targets"] = 1,
							}, -- [13]
							{
								["action"] = "sundering",
						...
						["precombat"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.windfury_totem.down",
								["action"] = "windfury_totem",
							}, -- [4]
							{
								["enabled"] = true,
					...
					["lists"] = {
						["essences"] = {
							...
							}, -- [5]
							{
								...
								["criteria"] = "time <= 10 || full_recharge_time < gcd || target.time_to_die < 5",
								["line_cd"] = "6",
							}, -- [6]
							{
						...
						["default"] = {
							...
							}, -- [4]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "spell_targets.mind_sear > 2",
							...
							}, -- [5]
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "( priest.self_power_infusion || runeforge.twins_of_the_sun_priestess.equipped ) & level >= 58 & cooldown.power_infusion.up || ( level < 58 || ! priest.self_power_infusion & ! runeforge.twins_of_the_sun_priestess.equipped ) & cooldown.void_eruption.up",
								["var_name"] = "pi_or_vf_sync_condition",
							}, -- [6]
							{
								["enabled"] = true,
						...
						["main"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.pi_or_vf_sync_condition & insanity >= 40",
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.searing_nightmare.enabled & spell_targets.mind_sear > ( variable.mind_sear_cutoff + 1 ) & ! dot.shadow_word_pain.ticking & ! cooldown.mindbender.up",
								["action"] = "mind_sear",
							}, -- [7]
							{
								["enabled"] = true,
								["criteria"] = "insanity <= 85 & ( ( talent.hungering_void.enabled & spell_targets.mind_sear < 5 ) || spell_targets.mind_sear = 1 )",
								["action"] = "void_bolt",
							}, -- [8]
							{
								["enabled"] = true,
							...
							}, -- [10]
							{
								...
								["criteria"] = "( refreshable || insanity > 75 ) & ! variable.pi_or_vf_sync_condition & ( ! talent.searing_nightmare.enabled || ( talent.searing_nightmare.enabled & ! variable.searing_nightmare_cutoff ) )",
								["cycle_targets"] = 1,
							}, -- [11]
							{
								["enabled"] = true,
								["criteria"] = "spell_targets.mind_sear < ( 4 + conduit.dissonant_echoes.enabled ) & insanity <= 85",
								["action"] = "void_bolt",
							}, -- [12]
							{
								["enabled"] = true,
								["action"] = "shadow_word_death",
								["criteria"] = "target.health.pct < 20 || ( pet.fiend.active & runeforge.shadowflame_prism.equipped )",
								["cycle_targets"] = 1,
							}, -- [13]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "dot.vampiric_touch.ticking & ( ( talent.searing_nightmare.enabled & spell_targets.mind_sear > ( variable.mind_sear_cutoff + 1 ) ) || dot.shadow_word_pain.ticking )",
								["action"] = "mindbender",
							}, -- [15]
							{
								["enabled"] = true,
								["criteria"] = "variable.all_dots_up & ! buff.voidform.up & target.time_to_die > 4",
								["action"] = "void_torrent",
							}, -- [16]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "spell_targets.shadow_crash = 1 & ( cooldown.shadow_crash.charges = 3 || debuff.shadow_crash_debuff.up || action.shadow_crash.in_flight || target.time_to_die < cooldown.shadow_crash.full_recharge_time ) & raid_event.adds.in > 30",
								["action"] = "shadow_crash",
							}, -- [18]
							{
								["enabled"] = true,
								["criteria"] = "raid_event.adds.in > 30 & spell_targets.shadow_crash > 1",
								["action"] = "shadow_crash",
							}, -- [19]
							{
								["enabled"] = true,
								...
								["criteria"] = "spell_targets.mind_sear > variable.mind_sear_cutoff & buff.dark_thoughts.up",
								["chain"] = "1",
							}, -- [20]
							{
								["enabled"] = true,
								...
								["interrupt_immediate"] = "1",
								["criteria"] = "buff.dark_thoughts.up & variable.dots_up",
								["chain"] = "1",
							}, -- [21]
							{
								["enabled"] = true,
								["criteria"] = "variable.dots_up & raid_event.movement.in > cast_time + 0.5 & spell_targets.mind_sear < 4",
								["action"] = "mind_blast",
							}, -- [22]
							{
								["enabled"] = true,
							...
							}, -- [24]
							{
								["enabled"] = true,
								["action"] = "shadow_word_pain",
								["criteria"] = "refreshable & target.time_to_die > 4 & ! talent.misery.enabled & ! ( talent.searing_nightmare.enabled & spell_targets.mind_sear > ( variable.mind_sear_cutoff + 1 ) ) & ( ! talent.psychic_link.enabled || ( talent.psychic_link.enabled & spell_targets.mind_sear <= 2 ) )",
								["cycle_targets"] = 1,
							}, -- [25]
							{
								["enabled"] = true,
						...
						["cds"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "runeforge.sephuzs_proclamation.equipped & ( target.is_add || debuff.casting.react )",
								["action"] = "silence",
							}, -- [2]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "insanity < 90 & ( variable.all_dots_up || buff.voidform.up )",
								["action"] = "mindgames",
							}, -- [4]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "! buff.voidform.up & ! cooldown.void_eruption.up & spell_targets.mind_sear > 1 & ! talent.searing_nightmare.enabled || ( buff.voidform.up & spell_targets.mind_sear < 2 & ! talent.searing_nightmare.enabled ) || ( buff.voidform.up & talent.searing_nightmare.enabled )",
						...
						["boon"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( spell_targets.mind_sear > 2 & talent.searing_nightmare.enabled || ( spell_targets.mind_sear > 1 & ! talent.searing_nightmare.enabled ) ) & spell_targets.ascended_nova > 1",
						...
						["cwc"] = {
							{
								...
								["cycle_targets"] = 1,
								["criteria"] = "( variable.searing_nightmare_cutoff & ! variable.pi_or_vf_sync_condition ) || ( dot.shadow_word_pain.refreshable & spell_targets.mind_sear > 1 )",
							}, -- [1]
							{
								["enabled"] = true,
								["use_while_casting"] = 1,
					...
					["lists"] = {
						["aoe"] = {
							...
							}, -- [8]
							{
								...
								["enable_moving"] = true,
								["action"] = "flame_shock",
								["criteria"] = "refreshable & buff.echoing_shock.down",
								["moving"] = 1,
							}, -- [9]
							{
								["moving"] = 1,
						...
						["single_target"] = {
							{
								["enabled"] = true,
								["action"] = "flame_shock",
								["criteria"] = "( ! ticking || dot.flame_shock.remains <= gcd ) & ! buff.surge_of_power.up & ! buff.echoing_shock.up",
								["cycle_targets"] = 1,
							}, -- [1]
							{
								["action"] = "ascendance",
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.health_pct > 80 || target.health_pct < 20 || fight_remains < 30",
								["action"] = "reaping_flames",
							}, -- [16]
							{
								["action"] = "heart_essence",
							...
							{
								["enabled"] = true,
								["criteria"] = "( maelstrom >= 60 || cooldown.lava_burst.remains <= gcd || buff.lava_surge.up )",
				...
				["Outlaw"] = {
					...
					["lists"] = {
						...
						["build"] = {
							{
								["enabled"] = true,
								["criteria"] = "runeforge.tiny_toxic_blade.equipped",
								["action"] = "shiv",
							}, -- [1]
							{
								["action"] = "echoing_reprimand",
						...
						["cds"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! buff.adrenaline_rush.up & ( ! cooldown.killing_spree.up || ! talent.killing_spree.enabled ) & ( ! equipped.azsharas_font_of_power || cooldown.latent_arcana.remains > 20 )",
								["action"] = "adrenaline_rush",
							}, -- [4]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "spell_targets >= 2 - conduit.ambidexterity.enabled & ! buff.blade_flurry.up & raid_event.adds.in > 10",
								["action"] = "blade_flurry",
							}, -- [8]
							{
								["enabled"] = true,
				...
				["Subtlety"] = {
					...
					["lists"] = {
						["stealthed"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.nightstalker.enabled & runeforge.tiny_toxic_blade.equipped",
								["action"] = "shiv",
							}, -- [5]
							{
								["enabled"] = true,
						...
						["cds"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.snd_condition & ! cooldown.shadow_blades.up & ( talent.enveloping_shadows.enabled || cooldown.shadow_dance.charges >= 1 ) & ( ! talent.shuriken_tornado.enabled || talent.shadow_focus.enabled || cooldown.shuriken_tornado.remains > 2 ) & ( ! essence.blood_of_the_enemy.major || cooldown.blood_of_the_enemy.remains > 2 )",
								["action"] = "symbols_of_death",
							}, -- [10]
							{
								["enabled"] = true,
		...
		["AbooseUI"] = {
			...
			["packs"] = {
				["Windwalker"] = {
					...
					["lists"] = {
						["cd_sef"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "fight_remains > 125 || buff.storm_earth_and_fire.up || fight_remains < 20",
								["action"] = "blood_fury",
							}, -- [20]
							{
								["enabled"] = true,
								["criteria"] = "fight_remains > 185 || buff.storm_earth_and_fire.up || fight_remains < 20",
								["action"] = "berserking",
							}, -- [21]
							{
								["action"] = "lights_judgment",
						...
						["opener"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "chi.max - chi = 3 || chi.max - chi = 1",
								["action"] = "expel_harm",
							}, -- [4]
							{
								["enabled"] = true,
								["criteria"] = "talent.hit_combo.enabled",
								["action"] = "flying_serpent_kick",
							}, -- [5]
							{
								["enabled"] = true,
								["criteria"] = "! settings.allow_fsk & talent.hit_combo.enabled",
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "time < 5 & chi < 5 & ! pet.xuen_the_white_tiger.active",
								["action"] = "call_action_list",
								["list_name"] = "opener",
							}, -- [5]
							{
								["enabled"] = true,
								["action"] = "fist_of_the_white_tiger",
								["criteria"] = "chi.max - chi >= 3 & ( energy.time_to_max < 1 || energy.time_to_max < 4 & cooldown.fists_of_fury.remains < 1.5 )",
								["cycle_targets"] = 1,
							}, -- [6]
							{
								["enabled"] = true,
								["criteria"] = "chi.max - chi >= 1 + essence.conflict_and_strife.major & ( energy.time_to_max < 1 || cooldown.serenity.remains < 2 || energy.time_to_max < 4 & cooldown.fists_of_fury.remains < 1.5 )",
								["action"] = "expel_harm",
							}, -- [7]
							{
								["enabled"] = true,
								["action"] = "tiger_palm",
								["criteria"] = "combo_strike & chi.max - chi >= 2 & ( energy.time_to_max < 1 || cooldown.serenity.remains < 2 || energy.time_to_max < 4 & cooldown.fists_of_fury.remains < 1.5 )",
								["cycle_targets"] = 1,
							}, -- [8]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "energy.time_to_max > execute_time - 1 || buff.storm_earth_and_fire.remains",
								["action"] = "fists_of_fury",
							}, -- [4]
							{
								["enabled"] = true,
								["action"] = "rising_sun_kick",
								["criteria"] = "( talent.whirling_dragon_punch.enabled & cooldown.rising_sun_kick.duration > cooldown.whirling_dragon_punch.remains + 3 ) & ( cooldown.fists_of_fury.remains > 3 || chi >= 5 )",
								["cycle_targets"] = 1,
							}, -- [5]
							{
								["enabled"] = true,
							...
							}, -- [12]
							{
								...
								["criteria"] = "combo_strike & ( buff.bok_proc.up || talent.hit_combo.enabled & prev_gcd.1.tiger_palm & ( chi.max - chi >= 14 & energy.time_to_50 < 1 || chi = 2 & cooldown.fists_of_fury.remains < 3 ) )",
								["cycle_targets"] = 1,
							}, -- [13]
						},
						["cd_serenity"] = {
							{
								...
								["op"] = "set",
								["action"] = "variable",
								["value"] = "cooldown.serenity.remains < 1 || fight_remains < 20",
							...
							{
								["enabled"] = true,
								["criteria"] = "fight_remains > 125 || variable.serenity_burst",
								["action"] = "blood_fury",
							}, -- [16]
							{
								["enabled"] = true,
								["criteria"] = "fight_remains > 185 || variable.serenity_burst",
								["action"] = "berserking",
							}, -- [17]
							{
								["enabled"] = true,
						...
						["st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.chi_energy.stack > 30 - 5 * active_enemies & combo_strike & buff.storm_earth_and_fire.down & ( cooldown.rising_sun_kick.remains > 2 & cooldown.fists_of_fury.remains > 2 || cooldown.rising_sun_kick.remains < 3 & cooldown.fists_of_fury.remains > 3 & chi > 3 || cooldown.rising_sun_kick.remains > 3 & cooldown.fists_of_fury.remains < 3 & chi > 4 || chi.max - chi <= 1 & energy.time_to_max < 2 ) || buff.chi_energy.stack > 10 & fight_remains < 7",
								["action"] = "spinning_crane_kick",
							}, -- [12]
							{
								["enabled"] = true,
				...
				["Beast Mastery"] = {
					...
					["lists"] = {
						...
						["st"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "focus + focus.regen * gcd < focus.max & buff.bestial_wrath.down & ( ! dot.concentrated_flame_burn.remains & ! action.concentrated_flame.in_flight ) || full_recharge_time < gcd || target.time_to_die < 5",
								["action"] = "concentrated_flame",
							}, -- [4]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.aspect_of_the_wild.up & buff.bestial_wrath.up || target.time_to_die < 15",
								["action"] = "stampede",
							}, -- [6]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.reckless_force.up || buff.reckless_force_counter.stack < 10 || target.time_to_die < 5",
								["action"] = "the_unbound_force",
							}, -- [9]
							{
								["enabled"] = true,
				...
				["Unholy"] = {
					...
					["lists"] = {
						["essences"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! buff.pillar_of_frost.up & ! buff.breath_of_sindragosa.up & ( target.health_pct >= 80 || target.health_pct <= 20 || fight_remains < 45 )",
								["action"] = "reaping_flames",
							}, -- [11]
						},
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.unholy_assault.up || pet.gargoyle.active || ( talent.army_of_the_damned.enabled & pet.apoc_ghoul.active )",
								["action"] = "berserking",
							}, -- [5]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.army_of_the_dead.ready || pet.gargoyle.active || buff.unholy_assault.up",
								["action"] = "potion",
							}, -- [25]
							{
								["enabled"] = true,
						...
						["cooldowns"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "debuff.festering_wound.stack >= 4 & ( active_enemies >= 2 || ! essence.vision_of_perfection.enabled || ! azerite.magus_of_the_dead.enabled || essence.vision_of_perfection.enabled & ( talent.unholy_assault.enabled & cooldown.unholy_assault.remains <= 3 || ! talent.unholy_assault.enabled ) )",
								["action"] = "apocalypse",
							}, -- [2]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_die > 14",
							...
							{
								["enabled"] = true,
								["criteria"] = "target.time_to_pct_34 < 5 & rune <= ( 1 - buff.unholy_assault.up )",
								["action"] = "soul_reaper",
							}, -- [11]
							{
						...
						["aoe"] = {
							{
								["enabled"] = true,
								["criteria"] = "cooldown.apocalypse.remains & active_dot.festering_wound > 0",
							...
							}, -- [8]
							{
								["enabled"] = true,
								["action"] = "festering_strike",
								["criteria"] = "( ( ( ( debuff.festering_wound.stack < 4 & ! buff.unholy_assault.up ) || debuff.festering_wound.stack < 3 ) & cooldown.apocalypse.remains < 3 ) || debuff.festering_wound.stack < 1 ) & ( cooldown.army_of_the_dead.remains > 5 )",
								["cycle_targets"] = 1,
							}, -- [9]
							{
								["enabled"] = true,
							...
							}, -- [12]
							{
								["enabled"] = true,
								["action"] = "scourge_strike",
								["criteria"] = "( ( cooldown.army_of_the_dead.remains > 5 || death_knight.disable_aotd ) & ( cooldown.apocalypse.remains > 5 & debuff.festering_wound.stack > 0 || debuff.festering_wound.stack > 4 ) & ( fight_remains < cooldown.death_and_decay.remains + 10 || fight_remains > cooldown.apocalypse.remains ) )",
								["cycle_targets"] = 1,
							}, -- [13]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "( ( ( ( debuff.festering_wound.stack < 4 & ! buff.unholy_assault.up ) || debuff.festering_wound.stack < 3 ) & cooldown.apocalypse.remains < 3 ) || debuff.festering_wound.stack < 1 ) & ( cooldown.army_of_the_dead.remains > 5 || death_knight.disable_aotd )",
								["action"] = "festering_strike",
							}, -- [16]
							{
								["enabled"] = true,
						...
						["generic"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.apocalypse.remains > 5 & debuff.festering_wound.up",
								["action"] = "scourge_strike",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "debuff.festering_wound.up & ( cooldown.apocalypse.remains > 5 || debuff.festering_wound.stack > 4 )",
								["action"] = "clawing_shadows",
							}, -- [4]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "debuff.festering_wound.stack < 4 & cooldown.apocalypse.remains < 3 || debuff.festering_wound.stack < 1",
								["action"] = "festering_strike",
							}, -- [6]
							{
								["enabled"] = true,
				...
				["Frost DK"] = {
					...
					["lists"] = {
						["cold_heart"] = {
							{
								["enabled"] = true,
								["criteria"] = "fight_remains < gcd || buff.pillar_of_frost.remains < 3 & buff.cold_heart.stack = 20 & ! talent.obliteration.enabled",
								["action"] = "chains_of_ice",
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "talent.obliteration.enabled & ! buff.pillar_of_frost.up & ( buff.cold_heart.stack >= 16 & buff.unholy_strength.up || buff.cold_heart.stack >= 19 )",
								["action"] = "chains_of_ice",
							}, -- [2]
						},
						["obliteration"] = {
						...
						["bos_ticking"] = {
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & runic_power <= 40 & ! talent.frostscythe.enabled",
								["action"] = "obliterate",
								["cycle_targets"] = 1,
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "runic_power <= 40",
								["action"] = "obliterate",
							}, -- [2]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & rune.time_to_5 < gcd || runic_power <= 45 & ! talent.frostscythe.enabled",
								["action"] = "obliterate",
								["cycle_targets"] = 1,
							}, -- [5]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & runic_power.deficit > 25 || rune > 3 & ! talent.frostscythe.enabled",
								["action"] = "obliterate",
								["cycle_targets"] = 1,
							}, -- [11]
							{
						...
						["bos_pooling"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.gathering_storm.enabled & rune >= 5",
								["action"] = "remorseless_winter",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & runic_power.deficit >= 25 & ! talent.frostscythe.enabled",
								["action"] = "obliterate",
								["cycle_targets"] = 1,
							}, -- [3]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & runic_power.deficit < 20 & ! talent.frostscythe.enabled & cooldown.pillar_of_frost.remains > 5",
								["action"] = "frost_strike",
								["cycle_targets"] = 1,
							}, -- [6]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & runic_power.deficit >= ( 35 + talent.runic_attenuation.enabled * 3 ) & ! talent.frostscythe.enabled",
								["action"] = "obliterate",
								["cycle_targets"] = 1,
							}, -- [10]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & cooldown.pillar_of_frost.remains > rune.time_to_4 & runic_power.deficit < 40 & ! talent.frostscythe.enabled",
								["action"] = "frost_strike",
								["cycle_targets"] = 1,
							}, -- [13]
							{
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & cooldown.remorseless_winter.remains <= 2 * gcd & talent.gathering_storm.enabled & ! talent.frostscythe.enabled",
								["action"] = "frost_strike",
								["cycle_targets"] = 1,
							}, -- [3]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & runic_power.deficit < ( 15 + talent.runic_attenuation.enabled * 3 ) & ! talent.frostscythe.enabled",
								["action"] = "frost_strike",
								["cycle_targets"] = 1,
							}, -- [8]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & runic_power.deficit > ( 25 + talent.runic_attenuation.enabled * 3 ) & ! talent.frostscythe.enabled",
								["action"] = "obliterate",
								["cycle_targets"] = 1,
							}, -- [14]
							{
							...
							{
								["enabled"] = true,
								["criteria"] = "( debuff.razorice.stack < 5 || ! death_knight.runeforge.razorice || debuff.razorice.remains < 10 ) & ! talent.frostscythe.enabled",
								["action"] = "frost_strike",
								["cycle_targets"] = 1,
							}, -- [17]
							{
						...
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "! dot.frost_fever.ticking & ( talent.icecap.enabled || cooldown.breath_of_sindragosa.remains > 15 || talent.obliteration.enabled & cooldown.pillar_of_frost.remains < dot.frost_fever.remains )",
								["action"] = "howling_blast",
							}, -- [2]
							{
								["enabled"] = true,
						...
						["cooldowns"] = {
							{
								["enabled"] = true,
								["criteria"] = "fight_remains > 14",
								["action"] = "shackle_the_unworthy",
							}, -- [1]
							{
								["enabled"] = true,
								["criteria"] = "active_enemies > 2 || boss",
								["action"] = "abomination_limb",
							}, -- [2]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "( buff.breath_of_sindragosa.up || fight_remains < 20 ) & talent.breath_of_sindragosa.enabled & runic_power.deficit > 30 & rune.time_to_5 > gcd",
								["action"] = "empower_rune_weapon",
							}, -- [9]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "talent.breath_of_sindragosa.enabled & cooldown.breath_of_sindragosa.remains || talent.icecap.enabled & ! buff.pillar_of_frost.up",
								["action"] = "pillar_of_frost",
							}, -- [11]
							{
								["enabled"] = true,
								["criteria"] = "talent.obliteration.enabled & ( talent.gathering_storm.enabled & buff.remorseless_winter.up & cooldown.raise_dead.ready || cooldown.raise_dead.remains || ! talent.gathering_storm.enabled )",
								["action"] = "pillar_of_frost",
							}, -- [12]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies >= 2 & cooldown.pillar_of_frost.remains + 15 > fight_remains || fight_remains < gcd",
								["action"] = "frostwyrms_fury",
							}, -- [15]
							{
								["enabled"] = true,
								["criteria"] = "talent.obliteration.enabled & ! buff.pillar_of_frost.up & ( ( death_knight.runeforge.fallen_crusader & buff.unholy_strength.up ) || ( death_knight.runeforge.razorice & debuff.razorice.stack = 5 ) || ( ! death_knight.runeforge.razorice & ! death_knight.runeforge.fallen_crusader ) )",
								["action"] = "frostwyrms_fury",
							}, -- [16]
							{
								["enabled"] = true,
								["criteria"] = "talent.breath_of_sindragosa.enabled & runic_power.deficit > 40 & rune >= 3 & cooldown.pillar_of_frost.up || ! talent.breath_of_sindragosa.enabled & runic_power.deficit >= 25",
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies >= 2 & ( pet.ghoul.remains < 2 * gcd || fight_remains < 2 * gcd )",
				...
				["Arcane"] = {
					...
					["lists"] = {
						...
						["essences"] = {
							{
								["enabled"] = true,
								["criteria"] = "cooldown.touch_of_the_magi.remains = 0 & buff.arcane_charge.stack <= variable.totm_max_charges & cooldown.arcane_power.remains <= gcd || fight_remains < cooldown.arcane_power.remains",
								["action"] = "blood_of_the_enemy",
							}, -- [1]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.arcane_power.remains >= 50 & cooldown.touch_of_the_magi.remains <= gcd & buff.arcane_charge.stack <= variable.totm_max_charges & talent.rune_of_power.enabled & cooldown.rune_of_power.remains <= gcd & cooldown.arcane_power.remains > variable.totm_max_delay",
								["action"] = "worldvein_resonance",
							}, -- [3]
							{
								["enabled"] = true,
						...
						["rotation"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.touch_of_the_magi.remains = 0 & ( buff.arcane_charge.stack > variable.totm_max_charges & talent.rune_of_power.enabled & cooldown.rune_of_power.remains <= gcd & cooldown.arcane_power.remains > variable.totm_max_delay & covenant.kyrian & cooldown.radiant_spark.remains <= 8 )",
								["action"] = "arcane_barrage",
							}, -- [2]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.touch_of_the_magi.remains = 0 & ( buff.arcane_charge.stack > variable.totm_max_charges & talent.rune_of_power.enabled & cooldown.rune_of_power.remains <= gcd & cooldown.arcane_power.remains > variable.totm_max_delay & ! covenant.kyrian )",
								["action"] = "arcane_barrage",
							}, -- [3]
							{
								["enabled"] = true,
								["criteria"] = "cooldown.touch_of_the_magi.remains = 0 & ( buff.arcane_charge.stack > variable.totm_max_charges & ! talent.rune_of_power.enabled & cooldown.arcane_power.remains > variable.totm_max_delay )",
								["action"] = "arcane_barrage",
							}, -- [4]
							{
								["enabled"] = true,
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.clearcasting.react & runeforge.arcane_infinity.equipped & talent.amplification.enabled & active_enemies < 9",
								["action"] = "arcane_missiles",
							}, -- [23]
							{
								["enabled"] = true,
								["criteria"] = "buff.clearcasting.react & runeforge.arcane_infinity.equipped & active_enemies < 6",
								["action"] = "arcane_missiles",
							}, -- [24]
							{
								["enabled"] = true,
						...
						["precombat"] = {
							...
							}, -- [1]
							{
								...
								["action"] = "variable",
								["value"] = "1",
								["criteria"] = "variable.prepull_evo = 0 & runeforge.siphon_storm.equipped & active_enemies > 2",
								["var_name"] = "prepull_evo",
							}, -- [2]
							{
								["enabled"] = true,
								...
								["action"] = "variable",
								["value"] = "1",
								["criteria"] = "variable.prepull_evo = 0 & runeforge.siphon_storm.equipped & covenant.necrolord & active_enemies > 1",
								["var_name"] = "prepull_evo",
							}, -- [3]
							{
								["enabled"] = true,
								...
								["action"] = "variable",
								["value"] = "1",
								["criteria"] = "variable.prepull_evo = 0 & runeforge.siphon_storm.equipped & covenant.night_fae",
								["var_name"] = "prepull_evo",
							}, -- [4]
							{
								["enabled"] = true,
							...
							}, -- [5]
							{
								...
								["action"] = "variable",
								["value"] = "1",
								["criteria"] = "variable.have_opened = 0 & active_enemies > 2",
								["var_name"] = "have_opened",
							}, -- [6]
							{
								["enabled"] = true,
								...
								["action"] = "variable",
								["value"] = "1",
								["criteria"] = "variable.have_opened = 0 & variable.prepull_evo = 1",
								["var_name"] = "have_opened",
							}, -- [7]
							{
								["enabled"] = true,
							...
							}, -- [12]
							{
								...
								["action"] = "variable",
								["value"] = "3",
								["criteria"] = "variable.totm_max_delay = 5 & runeforge.disciplinary_command.equipped",
								["var_name"] = "totm_max_delay",
							}, -- [13]
							{
								["enabled"] = true,
								...
								["action"] = "variable",
								["value"] = "15",
								["criteria"] = "variable.totm_max_delay = 5 & covenant.night_fae",
								["var_name"] = "totm_max_delay",
							}, -- [14]
							{
								["enabled"] = true,
								...
								["action"] = "variable",
								["value"] = "15",
								["criteria"] = "variable.totm_max_delay = 5 & conduit.arcane_prodigy.enabled & active_enemies < 3",
								["var_name"] = "totm_max_delay",
							}, -- [15]
							{
								["enabled"] = true,
								...
								["action"] = "variable",
								["value"] = "30",
								["criteria"] = "variable.totm_max_delay = 5 & essence.vision_of_perfection.minor",
								["var_name"] = "totm_max_delay",
							}, -- [16]
							{
								["enabled"] = true,
							...
							}, -- [17]
							{
								...
								["action"] = "variable",
								["value"] = "40",
								["criteria"] = "variable.barrage_mana_pct = 70 & covenant.night_fae",
								["var_name"] = "barrage_mana_pct",
							}, -- [18]
							{
								["enabled"] = true,
							...
							}, -- [19]
							{
								...
								["action"] = "variable",
								["value"] = "50",
								["criteria"] = "variable.ap_minimum_mana_pct = 30 & runeforge.disciplinary_command.equipped",
								["var_name"] = "ap_minimum_mana_pct",
							}, -- [20]
							{
								["enabled"] = true,
								...
								["action"] = "variable",
								["value"] = "50",
								["criteria"] = "variable.ap_minimum_mana_pct = 30 & runeforge.grisly_icicle.equipped",
								["var_name"] = "ap_minimum_mana_pct",
							}, -- [21]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.prepull_evo <= 0",
								["action"] = "frostbolt",
							}, -- [33]
							{
								["enabled"] = true,
						...
						["am_spam"] = {
							{
								["enabled"] = true,
								["criteria"] = "( cooldown.arcane_power.remains = 0 || cooldown.rune_of_power.remains <= gcd ) & buff.rune_of_power.down",
								["action"] = "touch_of_the_magi",
							}, -- [1]
							{
								["enabled"] = true,
						...
						["cooldowns"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "cooldown.arcane_power.remains < 50 & essence.vision_of_perfection.minor",
								["action"] = "touch_of_the_magi",
							}, -- [12]
							{
								["enabled"] = true,
								["criteria"] = "buff.arcane_charge.stack <= variable.totm_max_charges & talent.rune_of_power.enabled & cooldown.rune_of_power.remains <= gcd & cooldown.arcane_power.remains > variable.totm_max_delay & covenant.kyrian & cooldown.radiant_spark.remains <= 8",
								["action"] = "touch_of_the_magi",
							}, -- [13]
							{
								["enabled"] = true,
								["criteria"] = "buff.arcane_charge.stack <= variable.totm_max_charges & talent.rune_of_power.enabled & cooldown.rune_of_power.remains <= gcd & cooldown.arcane_power.remains > variable.totm_max_delay & ! covenant.kyrian",
								["action"] = "touch_of_the_magi",
							}, -- [14]
							{
								["enabled"] = true,
								["criteria"] = "buff.arcane_charge.stack <= variable.totm_max_charges & ! talent.rune_of_power.enabled & cooldown.arcane_power.remains > variable.totm_max_delay",
								["action"] = "touch_of_the_magi",
							}, -- [15]
							{
								["enabled"] = true,
								["criteria"] = "buff.arcane_charge.stack <= variable.totm_max_charges & cooldown.arcane_power.remains <= gcd",
								["action"] = "touch_of_the_magi",
							}, -- [16]
							{
								["enabled"] = true,
				...
				["Feral"] = {
					...
					["version"] = 20201020,
					["warnings"] = "WARNING:  The import for 'default' required some automated changes.\nLine 15: Converted SimC syntax % to Lua division operator (/) (2x).\n\nWARNING:  The import for 'precombat' required some automated changes.\nLine 4: Converted SimC syntax % to Lua division operator (/) (1x).\n\nImported 9 action lists.\n",
					["author"] = "SimC",
					["lists"] = {
						["filler"] = {
							{
						...
						["finisher"] = {
							{
								["enabled"] = true,
								["criteria"] = "buff.savage_roar.down || buff.savage_roar.remains < ( combo_points * 5 + 1 ) * 0.3",
								["action"] = "savage_roar",
							}, -- [1]
							{
								["enabled"] = true,
				...
				["Blood"] = {
					...
					["lists"] = {
						["essences"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "target.health_pct >= 80 || target.health_pct <= 20 || fight_remains < 45",
								["action"] = "reaping_flames",
							}, -- [6]
						},
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "runes.time_to_1 > gcd",
								["action"] = "blood_tap",
							}, -- [18]
							{
								["enabled"] = true,
								["criteria"] = "runic_power.deficit > 6 * active_enemies",
								["action"] = "swarming_mist",
							}, -- [19]
							{
								["enabled"] = true,
						...
						["standard"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.bone_shield.stack <= 6 & runic_power.deficit >= 15",
								["action"] = "marrowrend",
							}, -- [8]
							{
								["enabled"] = true,
								["criteria"] = "debuff.mark_of_blood.down & target.time_to_die > 7.5",
							...
							{
								["enabled"] = true,
								["criteria"] = "spell_targets.deaths_due >= 3",
								["action"] = "deaths_due",
							}, -- [13]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.crimson_scourge.up || talent.rapid_decomposition.enabled || spell_targets.deaths_due >= 2",
								["action"] = "deaths_due",
							}, -- [17]
							{
								["action"] = "consumption",
				...
				["Brewmaster"] = {
					...
					["lists"] = {
						["default"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "charges = charges_max & stagger.heavy & ( buff.purified_chi.down || buff.purified_chi.remains < 1.5 * gcd ) & cooldown.celestial_brew.remains < 5",
							...
							{
								["enabled"] = true,
								["criteria"] = "buff.blackout_combo.down & incoming_damage_2999ms > ( health.max * 0.05 + stagger.last_tick_damage_4 ) & buff.elusive_brawler.stack < 2",
								["action"] = "celestial_brew",
							}, -- [24]
							{
								["enabled"] = true,
								["criteria"] = "buff.purified_chi.up & ( buff.purified_chi.remains < 1.5 * gcd || cooldown.purifying_brew.remains > buff.purified_chi.remains )",
								["action"] = "celestial_brew",
							}, -- [25]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "active_enemies >= 3 & cooldown.keg_smash.remains > gcd & ( energy + ( energy.regen * ( cooldown.keg_smash.remains + gcd ) ) ) >= 65",
								["action"] = "spinning_crane_kick",
							}, -- [46]
							{
								["enabled"] = true,
					...
					["lists"] = {
						...
						["default"] = {
							...
							}, -- [11]
							{
								...
								["action"] = "variable",
								["value"] = "prev.starfire",
								["var_name"] = "prev_starfire",
							}, -- [12]
							{
								["enabled"] = true,
								["op"] = "set",
								["action"] = "variable",
								["value"] = "prev.starsurge",
								["var_name"] = "prev_starsurge",
							}, -- [13]
							{
								["enabled"] = true,
								["action"] = "run_action_list",
						...
						["aoe"] = {
							...
							{
								["enabled"] = true,
								["criteria"] = "variable.dream_will_fall_off & variable.starfall_wont_fall_off",
								["action"] = "starsurge",
							}, -- [5]
							{
								["enabled"] = true,
							...
							{
								["enabled"] = true,
								["criteria"] = "refreshable & target.time_to_die > ( 14 + ( spell_targets.starfire * 1.5 ) ) / spell_targets + remains & ( ( cooldown.ca_inc.ready || spell_targets.starfire < 3 || ( eclipse.in_solar || eclipse.in_both || eclipse.in_lunar & ! talent.soul_of_the_forest.enabled || buff.primordial_arcanic_pulsar.value >= 250 ) & ( spell_targets.starfire < 10 * ( 1 + talent.twin_moons.enabled ) ) & astral_power > 50 - buff.starfall.remains * 6 ) & ! buff.kindred_empowerment_energize.up & ap_check )",
								["action"] = "moonfire",
								["cycle_targets"] = 1,
							}, -- [8]
							{
