...
SimulationCraftDB = {
	["profileKeys"] = {
		...
		["Dateandrape - Scilla"] = "Dateandrape - Scilla",
		["Õbv - Area 52"] = "Õbv - Area 52",
		["Sevensins - Scilla"] = "Sevensins - Scilla",
