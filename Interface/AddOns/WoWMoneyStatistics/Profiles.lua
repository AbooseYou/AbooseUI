...
function profile.TransferFuncToProfile(setting)
   ...
   if _G.WOWMMChar.Minimap[setting] ~= nil then
      _G.WOWMSProfile[realm][player].Minimap[setting] = _G.WOWMMChar.Minimap[setting]
      _G.WOWMMChar.Minimap[setting] = nil
      return
   end
   
   if _G.WOWMMChar.StatDialog[setting] ~= nil then
      _G.WOWMSProfile[realm][player].StatDialog[setting] = _G.WOWMMChar.StatDialog[setting]
      _G.WOWMMChar.StatDialog[setting] = nil
      return
   end
end
